#ifndef OJ_TESTS_UNITS_INVALID_OPS
#define OJ_TESTS_UNITS_INVALID_OPS

#include "../../judge.h"
#include "../../utils/prelude.h"
#include "./tools.h"

char *invalid_ops1(void) {
    char *wkdir_path = workdir_concat("3");
    ...
    free(wkdir_path);
    free(case_path);
    SingleCaseResult scr_arr[4], single = SingleOperationNotPermitted;
