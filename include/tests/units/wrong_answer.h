#ifndef OJ_TESTS_UNITS_WRONG_ANSWER_H
#define OJ_TESTS_UNITS_WRONG_ANSWER_H

#include "../../judge.h"
#include "../../utils/prelude.h"
#include "./tools.h"

// example: 1 2 3 5  -> 3 3 3 5
char *wrong_answer1(void) {
    char *wkdir_path = workdir_concat("5");
    ...
    free(wkdir_path);
    free(case_path);
    SingleCaseResult scr_arr[4], single = SingleWrongAnswer;
