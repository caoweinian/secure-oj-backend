#ifndef OJ_TESTS_UNITS_TIME_EXCEEDED_H
#define OJ_TESTS_UNITS_TIME_EXCEEDED_H

#include "../../judge.h"
#include "../../utils/prelude.h"
#include "./tools.h"

char *time_exceeded1(void) {
    char *wkdir_path = workdir_concat("6");
    ...
    free(wkdir_path);
    free(case_path);
    SingleCaseResult scr_arr[4], single = SingleTimeLimitExceeded;
